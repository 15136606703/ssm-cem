...
<link href="js/jquery/bootstrap-datetimepicker-master/css/bootstrap-datetimepicker.min.css" type="text/css" rel="stylesheet" />

<script type="text/javascript" src="js/jquery/jquery-1.11.1-min.js"></script>
<script type="text/javascript" src="js/jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
<script type="text/javascript" src="js/jquery/bootstrap-datetimepicker-master/js/bootstrap-datetimepicker.js"></script>
<script type="text/javascript" src="js/jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>

	<link rel="stylesheet" type="text/css" href="js/jquery/bs_pagination/jquery.bs_pagination.min.css">
...
<script type="text/javascript">
	...
	$(function(){
		...
		* */
        ...
        /*
        * j动态生成的元素要以on的形式来出发
        * $(需要绑定元素的有效外层元素).on(绑定的方式，需要绑定的元素对象，回调函数)
        * */
	...
	/*
	* 分页查询： pageNum页面，pageSize每页展示的记录数
	* */
